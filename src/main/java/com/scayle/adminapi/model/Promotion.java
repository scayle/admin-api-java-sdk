...
public class Promotion implements ApiObjectInterface {
    ...
    */
    ...
    List<PromotionGlobalCondition> globalConditions;
    ...
    */
    ...
    List<PromotionItemCondition> itemConditions;
