...
public class CustomerService extends AbstractService {
    ...
    public void anonymizeAddressByIdentifier(String shopKey, String countryCode, Identifier addressIdentifier) throws ApiErrorException, ConnectionException {

        this.request("delete", this.resolvePath("/shops/%s/countries/%s/customers/addresses/%s/anonymize", shopKey, countryCode, addressIdentifier), null, null, null);
    }

    
    public void anonymizeAddressByIdentifier(String shopKey, String countryCode, Identifier addressIdentifier, ApiOptions options) throws ApiErrorException, ConnectionException {

        Map<String, Object> query = options.all();

        this.request("delete", this.resolvePath("/shops/%s/countries/%s/customers/addresses/%s/anonymize", shopKey, countryCode, addressIdentifier), query, null, null);
    }
